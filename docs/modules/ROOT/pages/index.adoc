...
- link:openfga-connector.adoc#_installation[OpenFGA Connector Installation]
- link:authzed-connector.adoc#_installation[Authzed Connector Installation]
...
are detailed link:annotations.adoc[here].
